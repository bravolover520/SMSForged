...
public class EasyDialog extends Dialog {
	...
	private Button mNegativeButton;	//消极
	...
	public void build(Builder builder) {
		...
		setContentView(R.layout.sdl_base);
	...
	private void findViews() {
		// Dialog Title
		mTitleLayout = (LinearLayout) findViewById(R.id.layout_dialog_title);
		...
		if (mBuilder.mMainDialogView != null) {
			...
			if (mBuilder.mShowHorzProgress) {
				if (mBuilder.mIndeterminateHorizontalProgress != null) {
					...
					mHorizontalProgress.setIndeterminate(true);	//ERROR
...
//					mHorizontalProgress.setIndeterminateDrawable(getContext().getResources().getDrawable(resId));  // Not sure why I need to do this
	...
	public static class Builder {
		...
		protected int mListRowTheme = EasyDialogListAdapter.THEME_HOLO;	//ERROR
		...
		public Builder(Context context, int themeId) {
			mContext = context;
			mThemeId = themeId;
			if (themeId == EasyDialog.THEME_HOLO) {	//ERROR
		 ...
		 * @return Builder object to allow for chaining of calls to set methods
		 */
		public Builder setListRowTheme(int theme) {	//ERROR
